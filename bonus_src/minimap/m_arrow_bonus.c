...
{
	minimap->lx3 = minimap->base_left_x + \
		(int)((minimap->base_right_x - minimap->base_left_x) * i / 10.0);
	minimap->ly3 = minimap->base_left_y + \
		(int)((minimap->base_right_y - minimap->base_left_y) * i / 10.0);
	minimap->outline_dx = minimap->lx3 - minimap->center_x;
	minimap->outline_dy = minimap->ly3 - minimap->center_y;
	if (minimap->outline_dx * minimap->outline_dx + minimap->outline_dy \
			* minimap->outline_dy <= minimap->radius * minimap->radius)
	{
		if (minimap->lx3 >= 0 && minimap->ly3 >= 0 && \
				minimap->lx3 < SCREEN_WIDTH && minimap->ly3 < SCREEN_HEIGHT)
...
{
	minimap->lx1 = minimap->base_left_x + \
		(int)((minimap->tip_x - minimap->base_left_x) * i / 20.0);
	minimap->ly1 = minimap->base_left_y + \
		(int)((minimap->tip_y - minimap->base_left_y) * i / 20.0);
	minimap->lx2 = minimap->base_right_x + \
		(int)((minimap->tip_x - minimap->base_right_x) * i / 20.0);
	minimap->ly2 = minimap->base_right_y + \
		(int)((minimap->tip_y - minimap->base_right_y) * i / 20.0);
...
{
	if (minimap->outline_dx1 * minimap->outline_dx1 + minimap->outline_dy1 \
			* minimap->outline_dy1 <= minimap->radius * minimap->radius)
	{
		if (minimap->lx1 >= 0 && minimap->ly1 >= 0 && \
				minimap->lx1 < SCREEN_WIDTH && minimap->ly1 < SCREEN_HEIGHT)
...
{
	if (minimap->outline_dx2 * minimap->outline_dx2 + minimap->outline_dy2 \
			* minimap->outline_dy2 <= minimap->radius * minimap->radius)
	{
		if (minimap->lx2 >= 0 && minimap->ly2 >= 0 && \
				minimap->lx2 < SCREEN_WIDTH && minimap->ly2 < SCREEN_HEIGHT)
